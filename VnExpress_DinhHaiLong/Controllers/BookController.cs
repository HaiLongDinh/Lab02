...
using VnExpress_DinhHaiLong.Models;

namespace VnExpress_DinhHaiLong.Controllers
{
    public class BookController : Controller
    {
        ...
        {
            return "Hello Dinh Hai Long - University" + university;
        }
        public ActionResult ListBook()
        {
            var books = new List<string>();
            books.Add("HTML 5 & CSS3 The complete Manual - Author Name Book 1");
        ...
        public ActionResult ListBookModel()
        {
            ...
            books.Add(new Book(1, "HTML 5 & CSS3 The complete Manual", "Author Name Book 1", "/Content/Images/book1cover.png"));
